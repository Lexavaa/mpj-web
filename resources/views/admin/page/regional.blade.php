...
@section('content')
    ...
    @foreach ($regional as $regionals)
        <div class="modal fade" id="Edit-{{ $regionals->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="p-4" method="post" action="/regional/{{ $regionals->id }}">
                        @method('patch')
                        @csrf
                        <div class="form-group">
                            <label for="Nama">Regional</label>
                            <input type="text" name="nama" class="@error('nama') is-invalid @enderror form-control"
                                id="Nama" placeholder="Nama" value="{{ old('nama', $regionals->nama) }}">
                            @error('nama')
                                ...
                                <tr>
                                    @foreach ($regional as $regionals)
                                        ...
                                        <td>
                                            ...
                                            <form action="/regional/{{ $regionals->id }}" class="d-inline" method="post">
                                                @method('delete')
                                                @csrf
        ...
        <div class="col-lg-4 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" action="/regional" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label for="Nama">Regional</label>
                            <input type="text" name="nama" class="@error('nama') is-invalid @enderror form-control"
