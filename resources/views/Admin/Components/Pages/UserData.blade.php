<x-AdminLayout title="Profil Pengguna">
<x-AlertScriptMolecules />
<x-CropStyleMolecules/>
                    ...
                    <div class="d-flex align-items-start align-items-sm-center gap-4">
                        <form enctype="multipart/form-data" action="{{ route('imageupload') }}" method="POST" class="avatar-upload">
                            ...
                            <div class="avatar-preview container2">
                                @php
                                    if (!empty($image->image) && $image->image != '' && file_exists(public_path('storage/logo-pesantren/' . $image->image))) {
                                        $image = $image->image;
                                    } else {
                                        $image = 'default.png';
                                    }
                                ...
                                @endphp 
                                <div id="imagePreview" style="background-image:url('{{ asset('/storage/logo-pesantren/' . $image) }}');">
